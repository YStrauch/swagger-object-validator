...
var Handler = (function () {
    function Handler(swaggerSpec, config) {
        ...
        this.config = config;
        this.swaggerSpec = (0, loader_1.loader)(swaggerSpec, config);
    }
        ...
        return this.swaggerSpec.then(function (spec) {
            ...
            if (typeof (schema) === 'string') {
                ...
                if (schema.startsWith('#/')) {
                    schemaPromise = (0, loader_1.loadSchema)((0, loader_1.resolveInternalPath)(schema, spec), spec, _this.config);
                }
                else {
                    schemaPromise = (0, loader_1.loadSchemaByName)(schema, spec, _this.config);
                }
            }
            else {
                trace.push({
            ...
            return schemaPromise
                .then(function (schema) { return (0, ModelValidator_1.validateModel)(test, schema, spec, _this.config, trace); })
