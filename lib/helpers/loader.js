...
exports.loadSchema = exports.resolveHashedPath = exports.loadSchemaByName = exports.loader = void 0;
...
function resolveHashedPath(path, spec) {
    if (!path.startsWith('#/')) {
...
exports.resolveHashedPath = resolveHashedPath;
